...
namespace {
  ...
  const char* labels[label_count] = {"0: Swipe up", "1: Swipe down", "2: Hand wave", "3: Clockwise", "4: Counter-clockwise"};
}  // namespace
...
void loop() {
  ...
  if (done_just_triggered) {
    ...
    RasterizeStroke(stroke_points, *stroke_transmit_length, 0.7f, 0.7f, raster_width, raster_height, raster_buffer);
    ...
    Serial.print("Tensor dimensions: ");
